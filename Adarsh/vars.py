...
class Var(object):
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://techiboyllcapp:james2424@streambot.trzn6ud.mongodb.net/?retryWrites=true&w=majority&appName=streambot'))
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'dryland21'))
